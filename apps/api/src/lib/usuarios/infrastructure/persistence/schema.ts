...
const SQL_CREAR_TABLA_USUARIOS = `CREATE TABLE IF NOT EXISTS usuarios (id TEXT PRIMARY KEY, nombre TEXT NOT NULL, hash_clave TEXT NOT NULL, rol TEXT NOT NULL, estado TEXT NOT NULL, creado_en TEXT NOT NULL, actualizado_en TEXT NOT NULL);`;
